...
<body>
    ...
    <th>
    <form  name="loginForm"  action="dateSearch"  method="post" > 
    From : <input type="text" id="txtdate" name="fromDate" autocomplete="off"  >
    To : <input type="text" id="txtdate1" name="toDate" autocomplete="off"  >
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <option>Inward Returnable</option>
    <option>Inward Non-Returnable</option>
    <option>Outward Returnable</option>
    <option>Outward Non-Returnable</option>
    </select>
